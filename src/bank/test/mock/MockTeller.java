...
public class MockTeller extends Mock {
	 ...
	 */
	public Teller cashier;
	private Menu menu;
	
	public class MyCustomer {
		public MockPerson customer;
		public String choice;
		public Check check;
		double amountPaid;
		MockWaiter waiter;
		public CustomerState state;
		public MyCustomer(MockPerson cust, MockWaiter w, String c){
			customer = cust;
			waiter = w;
			choice = c;
	...
	public MockTeller(String name, Menu m) {
		super(name);
		menu = m;
	}
	...
	public void msgProduceCheck(MockPerson c, MockWaiter w, String choice){
	...
	public void msgWaiterHere(MockPerson customer){
		MyCustomer mc = null;
	...
	public void msgHereIsPayment(MockPerson cust, double cash){
