...
import restaurant_cafe.test.mock.MockCook;
import restaurant_cafe.test.mock.MockCustomer;
import restaurant_cafe.test.mock.MockMarket;
import restaurant_cafe.test.mock.MockWaiter;
	...
	public void setUp() throws Exception{
		super.setUp();	
		 ...
		 Food food = new Food("Steak", 3000, 5, 4, 8, 15.99);
	        ...
	        cashier = new MockCashier("cashier", menu);		
	        customer0 = new MockCustomer("mockcustomer0");	
