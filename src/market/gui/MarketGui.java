...
//	JFrame animationFrame = new JFrame("Restaurant Animation");
	AnimationPanel animationPanel = new AnimationPanel(350,450);
     ...
     */    
    private MarketPanel mktPanel = new MarketPanel(this);
...
//    	animationFrame.add(animationPanel); 
        ...
        mktPanel.setPreferredSize(restDim);
        mktPanel.setMinimumSize(restDim);
        mktPanel.setMaximumSize(restDim);
        add(mktPanel);
...
//        }
    ...
    public int howManyWorkers() {
    	return mktPanel.howManyWorkers();
    }
}
